 ...
 ** 
 **/
void	ClapTrap::getInformation()
{
	std::cout << "ClapTrap " << m_name << " has " << m_hitPoints << " hit points, "
		<< m_energyPoints << " energy points, " << m_attackDamage << " attack damage, "
		<< m_maxHitPoints << " max hit points, " << m_maxEnergyPoints << " max energy points" << std::endl;
}